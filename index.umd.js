(function (global, factory) {
	...
	(global.orderAssetsPairs = factory());
	...
	var buffer = ( bufferEs6 && undefined ) || bufferEs6;
	...
	var safeBuffer$1 = /*#__PURE__*/Object.freeze({
		default: safeBuffer,
		__moduleExports: safeBuffer,
		Buffer: safeBuffer_1
	});

	var require$$0 = ( safeBuffer$1 && safeBuffer ) || safeBuffer$1;
	...
	var orderPair = function orderPair(_ref) {
	  ...
	  switch (true) {
	    ...
	    case !isFirstInList && isSecondInList:
	      return [first, second];
	    default:
	      return compareUint8Arrays(bs58.decode(first), bs58.decode(second)) ? [second, first] : [first, second];
	  }
	};
